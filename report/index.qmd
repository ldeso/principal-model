...
Phase C scaffolding now lives at [phase-c.qmd](phase-c.qmd) — an
interactive simulator whose price dynamics and demand model will be
upgraded iteratively (jump-diffusion, Poisson demand, calibration,
dynamic hedging).
